...
**VoiceControlledBot** is a Bluetooth-based robot control system developed for a robotics workshop conducted by the **Robotics Club of CEG** in collaboration with **ECEA**.
...
3. Install the Android `.apk` from the `android_app` folder.
